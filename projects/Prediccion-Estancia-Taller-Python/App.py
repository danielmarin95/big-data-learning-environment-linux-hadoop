...
input_path = "hdfs:///user/hdoop/taller/input/car_workshop_dataset.csv"
...
# CAMBIO: Se añadió esta línea para asegurar el tipo de dato correcto ---------------------->  cambio
...
output_path = "hdfs:///user/hdoop/taller/output/predictions"
...
model_path = "hdfs:///user/hdoop/taller/output/model"
